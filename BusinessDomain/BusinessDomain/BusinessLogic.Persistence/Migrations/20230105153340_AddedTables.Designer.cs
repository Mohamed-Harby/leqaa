...
namespace BusinessLogic.Persistence.Migrations
{
    ...
    [Migration("20230105153340_AddedTables")]
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Announcement", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 1, 5, 17, 33, 40, 529, DateTimeKind.Local).AddTicks(5574));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Channel", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 1, 5, 17, 33, 40, 529, DateTimeKind.Local).AddTicks(7129));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Hub", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 1, 5, 17, 33, 40, 529, DateTimeKind.Local).AddTicks(9277));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 1, 5, 17, 33, 40, 530, DateTimeKind.Local).AddTicks(315));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Room", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 1, 5, 17, 33, 40, 530, DateTimeKind.Local).AddTicks(1069));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 1, 5, 17, 33, 40, 535, DateTimeKind.Local).AddTicks(5653));

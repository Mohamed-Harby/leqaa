...
{
    public class GetHubsWithoutUserHubsHandler : IHandler<GetHubsWithoutUserHubsQuery, ErrorOr<List<UserReadModel>>>
    {
      ...
      private readonly IUserHubRepository _userHubRepository;
        ...
        public async Task<ErrorOr<List<UserReadModel>>> Handle(GetHubsWithoutUserHubsQuery request, CancellationToken cancellationToken)
        {

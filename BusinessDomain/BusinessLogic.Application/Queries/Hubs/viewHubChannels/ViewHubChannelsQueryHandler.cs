...
{
    public class ViewHubUsersQueryHandler : IHandler<ViewHubChannelsQuery, ErrorOr<List<ChannelReadModel>>>
    {
        private readonly IHubRepository _hubRepository;

        private readonly IChannelRepository _channelRepository;

        public ViewHubUsersQueryHandler(IHubRepository hubRepository,IChannelRepository channelRepository)
        {

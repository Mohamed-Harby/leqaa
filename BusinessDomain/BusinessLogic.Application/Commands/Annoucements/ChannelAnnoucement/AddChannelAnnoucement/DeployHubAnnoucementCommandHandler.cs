...
public class DeployHubAnnoucementCommandHandler : IHandler<DeployChannelAnnoucementCommand, ErrorOr<ChannelAnnoucementReadModel>>
{
    ...
    public async Task<ErrorOr<ChannelAnnoucementReadModel>> Handle(DeployChannelAnnoucementCommand request, CancellationToken cancellationToken)
    {
        ...
        return channelAnnoucements.Adapt<ChannelAnnoucementReadModel>();

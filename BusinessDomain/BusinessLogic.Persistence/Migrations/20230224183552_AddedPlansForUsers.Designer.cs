...
namespace BusinessLogic.Persistence.Migrations
{
    ...
    [Migration("20230224183552_AddedPlansForUsers")]
    partial class AddedPlansForUsers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Announcement", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 2, 24, 20, 35, 52, 501, DateTimeKind.Local).AddTicks(7606));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Channel", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 20, 35, 52, 501, DateTimeKind.Local).AddTicks(9638));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Hub", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 20, 35, 52, 502, DateTimeKind.Local).AddTicks(4611));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 20, 35, 52, 502, DateTimeKind.Local).AddTicks(7399));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Role.Plan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 20, 35, 52, 502, DateTimeKind.Local).AddTicks(5975));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Room", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 20, 35, 52, 502, DateTimeKind.Local).AddTicks(8504));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 20, 35, 52, 509, DateTimeKind.Local).AddTicks(3549));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.UserChannel", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 20, 35, 52, 505, DateTimeKind.Local).AddTicks(198));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.UserHub", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 20, 35, 52, 512, DateTimeKind.Local).AddTicks(3518));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.UserRoom", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 20, 35, 52, 515, DateTimeKind.Local).AddTicks(4789));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.UserUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 20, 35, 52, 515, DateTimeKind.Local).AddTicks(9355));

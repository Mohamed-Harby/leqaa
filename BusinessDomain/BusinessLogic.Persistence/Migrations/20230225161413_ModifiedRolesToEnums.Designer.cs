...
namespace BusinessLogic.Persistence.Migrations
{
    ...
    [Migration("20230225161413_ModifiedRolesToEnums")]
    partial class ModifiedRolesToEnums
    {
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Announcement", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 2, 25, 16, 14, 13, 217, DateTimeKind.Utc).AddTicks(8759));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Channel", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 25, 16, 14, 13, 217, DateTimeKind.Utc).AddTicks(9674));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Hub", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 25, 16, 14, 13, 218, DateTimeKind.Utc).AddTicks(2409));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Plan.Plan", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 25, 16, 14, 13, 219, DateTimeKind.Utc).AddTicks(9746));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 25, 16, 14, 13, 220, DateTimeKind.Utc).AddTicks(1659));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.Room", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 25, 16, 14, 13, 220, DateTimeKind.Utc).AddTicks(2811));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 25, 16, 14, 13, 222, DateTimeKind.Utc).AddTicks(2720));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.UserChannel", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 25, 18, 14, 13, 222, DateTimeKind.Local).AddTicks(1693));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.UserHub", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 25, 18, 14, 13, 226, DateTimeKind.Local).AddTicks(5188));

                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                        .HasDefaultValue(new Guid("1666ca24-48b6-4cdd-9f3a-4c89ccd478a7"));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.UserRoom", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 25, 18, 14, 13, 229, DateTimeKind.Local).AddTicks(8205));
            ...
            modelBuilder.Entity("BusinessLogic.Domain.UserUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 25, 18, 14, 13, 230, DateTimeKind.Local).AddTicks(3198));

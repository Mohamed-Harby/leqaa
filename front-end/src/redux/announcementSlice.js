...
const baseUrl = "http://localhost:5004/api/v1/Annoucement/";
...
export const deployChannelAnnoucement = createAsyncThunk(
    ...
    async (payload) => {
        ...
        try {
            const response = await axios.post(baseUrl + deployChannelAnnoucementUrl, payload.data, {
                headers: {
...
export const deployHubAnnoucement = createAsyncThunk(
    ...
    async (payload) => {
        ...
        try {
            const response = await axios.post(baseUrl + deployHubAnnoucementUrl, payload.data, {
                headers: {
                    Authorization: `Bearer ${payload.token}`
                },
            });
...
export const getResponseChannelAnnoucement = (state) => state.announcement.channelAnnoucement;
export const getResponsehubAnnoucement = (state) => state.announcement.hubAnnoucement;
export const getResponseGethubAnnoucements = (state) => state.announcement.hubAnnoucements;
